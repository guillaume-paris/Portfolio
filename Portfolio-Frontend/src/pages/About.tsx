    ...
    return (
        <div className="h-screen pt-24 flex flex-col items-center">
            ...
            <ol className="relative border-l-4 border-gray-700 m-10">                  
                ...
                <li className="mb-10 ml-4">
                    <div className={`absolute w-4 h-4 rounded-full -left-2.5 border border-gray-900 bg-gray-700 transform ${loaded ? 'opacity-100' : 'opacity-0'} transition-all duration-700 ease-out`} style={{ transitionDelay: '1s' }}></div>
                    <div className={`transform ${loaded ? 'translate-x-0 opacity-100' : 'translate-x-40 opacity-0'} transition-all duration-700 ease-out`} style={{ transitionDelay: '1s' }}>
